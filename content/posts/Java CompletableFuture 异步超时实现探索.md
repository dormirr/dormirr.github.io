...
share: true
date: 2024-01-22T21:11:00
lastmod: 2025-09-20T22:32:00
categories: 编程笔记
---
...
当异步任务是一个 RPC 请求时，我们可以设置一个 JSF（类似 Dubbo 的中间件） 超时，以达到异步超时效果。

当请求是一个 R2M（类似 Jedis 的中间件） 请求时，我们也可以控制 R2M 连接的最大超时时间来达到效果。
...
1. [JEP 266: JDK 9 并发包更新提案](https://link.zhihu.com/?target=https://bugs.openjdk.org/browse/JDK-8132960)
